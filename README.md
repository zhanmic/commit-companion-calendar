...
4. Mirror slug/displayName/`defaultTimeZone`/`dailySendHour`/`weeklySendHour` (and optional `publicApiHouseholds`) in `api/_lib/tenants.js` for `/api/tenants`, `/api/schedule`, + digests.
